                    ...
                    <div className={styleSecond.size__company}>
                       ...
                       <button type='button' 
                        ...
                        style={{cursor: 'pointer',
                            backgroundColor: '#FFFF66',
                            color: '#ff9900',
                            border:"1px solid #ff9900"}}  className={styleSecond.company__continue_btn}>Continue</button>
                    </div>
                </div>
            </section>
:form==3?
            ...
            <div className={styleThird.register__header}>
               ...
               <button type='button' style={{cursor: 'pointer',
                            backgroundColor: '#FFFF66',
                            color: '#ff9900',
                            border:"1px solid #ff9900"}} onClick={(event) => onRegister(event)} className={styleThird.company__continue_btn}>Continue</button>
            </div>   
        </section>
:form==4?
        <section className={styleSecond.frame__register}>
