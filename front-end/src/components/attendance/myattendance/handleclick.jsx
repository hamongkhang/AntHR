...
import { Divider, Grid, Typography, TextField, TextareaAutosize, Modal } from "@mui/material";
    ...
    return (
        <>
            ...
            >
                ...
                <Box onClick={handlePaidTime} style={styles.option_dropdown_content_li} className={props.classes.hover_li}>
                    <Typography>
                ...
                <Box onClick={handleOverTime} style={styles.option_dropdown_content_li} className={props.classes.hover_li}>
                    <Typography>
                        <DriveFileRenameOutlineOutlinedIcon />&nbsp;
                        Edit OverTime
                    </Typography>
            ...
            <Modal
                ...
                <Box className={props.classes.modal_block}>
                    <Box className={props.classes.modal_body}>
                        <Grid container>
                            <Grid item xs={6}>
                                <Typography variant="h5" className={props.classes.modal_head_text}>
                                    {title}
                                </Typography>
                            </Grid>
                            <Grid item xs={6} className={props.classes.modal_close_icon} onClick={handleClose2}>
                                <CloseIcon />
                            </Grid>
                        </Grid>
